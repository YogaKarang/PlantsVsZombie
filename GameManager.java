...
public class GameManager {
            ...
            try {
                ...
                if (pilih == 0) {
                    ...
                    if (!adaTanaman) {
                        ...
                        System.out.println(
                                "Pasang minimal 1 tanaman terlebih dahulu!"
                        );
                ...
                switch (pilih) {
                    ...
                    default:
                        throw new PilihanTidakValidException(
                                pilih
                        );
                }
    ...
    private void spawnZombie() {
        ...
        if (arena.getZombies()[lane][4]
                == null) {

            Zombie zombie =
                    createZombie();

            arena.getZombies()[lane][4]
                    = zombie;
    ...
    private void plantAttack() {
        ...
        for (int i = 0;
            ...
            for (int j = 0;
                ...
                if (plant == null
                        || plant instanceof ProtectiveNuts) {
